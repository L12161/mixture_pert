...
data = generate_uniform(N_user,N_loc);
...
%% Plot of Theoretical L1 Distance - Included points (solid lines with filled markers)
h1=plot(myEpsilon, result(1,~isExcluded), '-.o', 'Color', Color(1,:), 'LineWidth', 1.3, 'MarkerFaceColor', Color(1,:));
h2=plot(myEpsilon, result(2,~isExcluded), '-.s', 'Color', Color(2,:), 'LineWidth', 1.3, 'MarkerFaceColor', Color(2,:));
h3=plot(myEpsilon, result(3,~isExcluded), '-.^', 'Color', Color(3,:), 'LineWidth', 1.3, 'MarkerFaceColor', Color(3,:));
h4=plot(myEpsilon, result_min(4,~isExcluded), '-.p', 'Color', Color(5,:), 'LineWidth', 1.3, 'MarkerFaceColor', Color(5,:));

%% Plot of Excluded points (dashed lines with hollow markers)
plot(myEpsilon_full(isExcluded), result(1,isExcluded), '--o', 'Color', Color(1,:), 'LineWidth', 1, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', Color(1,:));
plot(myEpsilon_full(isExcluded), result(2,isExcluded), '--s', 'Color', Color(2,:), 'LineWidth', 1, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', Color(2,:));
plot(myEpsilon_full(isExcluded), result(3,isExcluded), '--^', 'Color', Color(3,:), 'LineWidth', 1, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', Color(3,:));
plot(myEpsilon_full(isExcluded), result_min(4,isExcluded), '--p', 'Color', Color(5,:), 'LineWidth', 1, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', Color(5,:));
